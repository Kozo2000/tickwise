...
Tickwise の基本解析が目指すもの

Tickwise の基本解析は、
「この指標がこうだから買い」と断定するためのものではない。
...
Tickwise が EMA を基本指標として採用している理由は、
...
他の指標（RSI / MACD / ADX など）と役割が被らない

という点にある。

EMA は「判断を出す指標」ではなく、
判断の前提となる“流れ”を示す指標である。
