...
#### 注意事項　KEY オプションについて
コマンドラインからのbrave_api_keyおよびopenai_api_keyオプションで本プログラムを動作させることは推奨しておりません。理由として、コマンドラインから実行するとコマンドヒストリに各種KEY情報が記載されてしまい、何かの侵害が発生した場合、コマンドヒストリ情報からKEY情報が奪われることが想定できます。
